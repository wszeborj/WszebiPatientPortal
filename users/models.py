...
class User(AbstractUser):
    ...
    role = models.CharField(max_length=20, choices=ROLE_CHOICES, help_text="Role of the user")
    ...
    avatar = models.ImageField(upload_to="avatar of user", help_text="Image of user's avatar.", max_length=255, blank=True)
